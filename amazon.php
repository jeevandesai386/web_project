...
<a href="feed1.php"><img src="images/microsoft.png" align="center" width="65" height="70"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<center><p><h1><u>AMAZON</u></h1><h3><?php
  $rss = new DOMDocument();
  $rss->load('http://feeds.feedburner.com/TechCrunch/Amazon');
  $feed = array();
